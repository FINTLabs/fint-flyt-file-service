...
data class FilePayload(
    ...
    override fun toString(): String {
        return "FilePayload(sourceApplicationId=$sourceApplicationId, " +
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + sourceApplicationId.hashCode()
        result = 31 * result + sourceApplicationInstanceId.hashCode()
